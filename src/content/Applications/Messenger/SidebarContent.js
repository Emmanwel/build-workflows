    ...
    <RootWrapper>
      ...
      <Box mt={2}>
        {currentTab === 'all' && (
          <List disablePadding component="div">
            <ListItemWrapper selected>
              <ListItemAvatar>
                <Avatar src="/static/images/avatars/meme.jpg" />
              </ListItemAvatar>
              <ListItemText
                sx={{
                  mr: 1
            ...
            <ListItemWrapper>
              <ListItemAvatar>
                <Avatar src="/static/images/avatars/me2.jpg" />
              </ListItemAvatar>
              <ListItemText
                sx={{
                  mr: 1
            ...
            <ListItemWrapper>
              <ListItemAvatar>
                <Avatar src="/static/images/avatars/mem.jpg" />
              </ListItemAvatar>
              <ListItemText
                sx={{
                  mr: 1
        ...
        {currentTab === 'unread' && (
          <List disablePadding component="div">
            ...
            <ListItemWrapper>
              <ListItemAvatar>
                <Avatar src="/static/images/avatars/m4.jpg" />
              </ListItemAvatar>
              <ListItemText
                sx={{
                  mr: 1
      ...
      <MeetingBox>
        ...
        <Box display="flex" alignItems="center" justifyContent="space-between">
          <AvatarGroup>
            <Tooltip arrow title="View profile for Mukhebi ">
              <Avatar
                sx={{
                  width: 28,
                  height: 28
                ...
                component={Link}
                href="#"
                alt="Emmanuel Mukhebi "
                src="/static/images/avatars/me1.jpg"
              />
            </Tooltip>
            <Tooltip arrow title="View profile for Lole ">
              <Avatar
                sx={{
                  width: 28,
                  height: 28
                ...
                href="#"
                alt="Lole Wetu "
                src="/static/images/avatars/meme.jpg"
              />
            </Tooltip>
            <Tooltip arrow title="View profile for Olai aa ana">
              <Avatar
                sx={{
                  width: 28,
                  height: 28
                ...
                href="#"
                alt="Olai nanana "
                src="/static/images/avatars/3ms.jpg"
              />
            </Tooltip>
          </AvatarGroup>
